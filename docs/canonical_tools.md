...
This document defines the canonical MCP resources and tools for the BREACH project.
The same names must be used in the xLabMcp project documents to avoid drift.
...
The following names may appear only in archived history or legacy compatibility notes:
